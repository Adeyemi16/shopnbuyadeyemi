...
export default function Profile() {
    ...
    const { error, data, loading } = useFetchData(getUserProfile, username, currentUser?.access_Token)
    useEffect(() => {
        ...
        <div>
            ...
            <Row className="align-items-center justify-content-around gy-2">
                <Col md={12} className="text-center  mb-4">
                    <Image src={data?.profileImg} className="rounded-circle object-fit-cover mb-4 shadow" style={{ width: "100px", height: '100px' }} />

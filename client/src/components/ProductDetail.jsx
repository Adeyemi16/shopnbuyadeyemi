    ...
    <>
      <PageLayout>
        <Row className="justify-content-around g-4 mt-2">
          {state?.errorMessage && <p className="fs-5">{state?.errorMessage}</p>}
          ...
          <Col lg={3}>
            ...
            <p className="mt-3 fs-5">{formatCurrency(state?.product?.price)}</p>
            <Button
              variant="dark"
            ...
            <div className="mt-5">
              <p className="fw-bold fs-6 text-uppercase">Product description</p>
            ...
            {state?.product?.extra?.length > 0 && (
              <div className="mt-5">
                ...
                {state?.product?.extra?.map((item, i) => (
                  <p key={i} className="fs-6 text-black">
                    - {item}
                  </p>
                ))}
              </div>
